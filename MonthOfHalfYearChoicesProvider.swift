//
//  MonthOfHalfYearChoicesProvider.swift
...
import Foundation
import UIKit
class MonthOfHalfYearChoicesProvider:OccursChoicesProvider {
    ...
    override func buildStringChoices()->[String] {
        return self.numberSubChoices!.map(){ String.namesOfMonthNumbersOfHalfYear($0) }
    }
